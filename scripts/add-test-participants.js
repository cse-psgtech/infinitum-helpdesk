...
const ParticipantSchema = new mongoose.Schema({
  ...
  registered_via: { type: String, required: true, default: 'onspot' },
}, { timestamps: true });
...
async function addTestParticipants() {
  try {
    ...
    console.log('  • INFIN1234 - Can provide kit (Paid, not provided yet)');
    console.log('  • INFIN5678 - Can provide kit (Paid, not provided yet)');
    console.log('  • INFIN9999 - Cannot provide kit (Not paid)');
    console.log('  • INFIN1111 - Already provided kit (should show warning)\n');
